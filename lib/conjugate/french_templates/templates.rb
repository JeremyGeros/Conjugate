...
FrenchTemplates = {
  ...
  :copier_collier => {
  	:infinitive => "copier_coller", 
  	:present => {
  		:je => "copie-colle",
  		:tu => "copies-colles",
  		:il => "copie-colle",
  		:nous => "copions-collons",
  		:vous => "copiez-collez",
  		:ils => "copient-collent"
  	}, 
  	:imperfect => {
  		...
  		:tu => "copiais-collais",
  		:il => "copiait-collait",
  		:nous => "copiions-collions",
  		:vous => "copiiez-colliez",
  		:ils => "copiaient-collaient"
  	},
  	:past_historic => {
  		:je => "copiai-collai",
  		:tu => "copias-collas",
  		:il => "copia-colla",
  		:nous => "copiâmes-collâmes",
  		:vous => "copiâtes-collâtes",
  		:ils => "copièrent-collèrent"
  	},
  	:future => {
  		:je => "copierai-collerai",
  		:tu => "copieras-colleras",
  		:il => "copiera-collera",
  		:nous => "copierons-collerons",
  		:vous => "copierez-collerez",
  		:ils => "copieront-colleront"
  	},
  	:conditional => {
  		:je => "copierais-collerais",
  		:tu => "copierais-collerais",
  		:il => "copierait-collerait",
  ...
  :e_er => {
  	...
  	:present_participle => "{{{1}}}e{{{2}}}ant",
    :past_participle => "{{{1}}}e{{{2}}}é"
  },
  ...
  :é_er => {
  	...
  	:present_participle => "{{{1}}}é{{{2}}}ant",
    :past_participle => "{{{1}}}é{{{2}}}é"
  },
  
  :e_é_er => {
  	:infinitive => "{{{1}}}e{{{2}}}é{{{3}}}er", 
  	:present => {
  		:je => "{{{1}}}e{{{2}}}è{{{3}}}e",
  		:tu => "{{{1}}}e{{{2}}}è{{{3}}}es",
  		:il => "{{{1}}}e{{{2}}}è{{{3}}}e",
  	...
  	:conditional => {
  		...
  		:tu => "{{{1}}}e{{{2}}}é{{{3}}}erais",
  		:il => "{{{1}}}e{{{2}}}é{{{3}}}erait",
  		:nous => "{{{1}}}e{{{2}}}é{{{3}}}erions",
  		:vous => "{{{1}}}e{{{2}}}é{{{3}}}eriez",
  		:ils => "{{{1}}}e{{{2}}}é{{{3}}}eraient"
  	},
  	
  	:present_participle => "{{{1}}}e{{{2}}}é{{{3}}}ant",
    :past_participle => "{{{1}}}e{{{2}}}é{{{3}}}é"
  },
  
  :é_é_er => {
  	:infinitive => "{{{1}}}é{{{2}}}é{{{3}}}er", 
  	:present => {
  		:je => "{{{1}}}é{{{2}}}è{{{3}}}e",
  		:tu => "{{{1}}}é{{{2}}}è{{{3}}}es",
  		:il => "{{{1}}}é{{{2}}}è{{{3}}}e",
  	...
  	:conditional => {
  		...
  		:tu => "{{{1}}}é{{{2}}}é{{{3}}}erais",
  		:il => "{{{1}}}é{{{2}}}é{{{3}}}erait",
  		:nous => "{{{1}}}é{{{2}}}é{{{3}}}erions",
  		:vous => "{{{1}}}é{{{2}}}é{{{3}}}eriez",
  		:ils => "{{{1}}}é{{{2}}}é{{{3}}}eraient"
  	},
  	
  	:present_participle => "{{{1}}}é{{{2}}}é{{{3}}}ant",
    :past_participle => "{{{1}}}é{{{2}}}é{{{3}}}é"
  },
  ...
  :e_xx_er => {
  	...
  	:future => {
  		...
  		:tu => "{{{1}}}e{{{2}}}e{{{3}}}{{{3}}}eras",
  		:il => "{{{1}}}e{{{2}}}e{{{3}}}{{{3}}}era",
  		:nous => "{{{1}}}e{{{2}}}e{{{3}}}{{{3}}}erons",
  		:vous => "{{{1}}}e{{{2}}}e{{{3}}}{{{3}}}erez",
  		:ils => "{{{1}}}e{{{2}}}e{{{3}}}{{{3}}}eront"
  	},
  	:conditional => {
  		:je => "{{{1}}}e{{{2}}}e{{{3}}}{{{3}}}erais",
  		:tu => "{{{1}}}e{{{2}}}e{{{3}}}{{{3}}}erais",
  		:il => "{{{1}}}e{{{2}}}e{{{3}}}{{{3}}}erait",
  		:nous => "{{{1}}}e{{{2}}}e{{{3}}}{{{3}}}erions",
  		:vous => "{{{1}}}e{{{2}}}e{{{3}}}{{{3}}}eriez",
  		:ils => "{{{1}}}e{{{2}}}e{{{3}}}{{{3}}}eraient"
  	},
  	
  	:present_participle => "{{{1}}}e{{{2}}}e{{{3}}}ant",
    :past_participle => "{{{1}}}e{{{2}}}e{{{3}}}é"
  },
  
  
  :é_xx_er => {
  	:infinitive => "{{{1}}}é{{{2}}}e{{{3}}}er", 
  	:present => {
  		:je => "{{{1}}}é{{{2}}}e{{{3}}}{{{3}}}e",
  		:tu => "{{{1}}}é{{{2}}}e{{{3}}}{{{3}}}es",
  		:il => "{{{1}}}é{{{2}}}e{{{3}}}{{{3}}}e",
  		:nous => "{{{1}}}é{{{2}}}e{{{3}}}{{{3}}}ons",
  		:vous => "{{{1}}}é{{{2}}}e{{{3}}}{{{3}}}ez",
  		:ils => "{{{1}}}é{{{2}}}e{{{3}}}{{{3}}}ent"
  	}, 
  	:imperfect => {
  	...
  	:future => {
  		...
  		:tu => "{{{1}}}é{{{2}}}e{{{3}}}{{{3}}}eras",
  		:il => "{{{1}}}é{{{2}}}e{{{3}}}{{{3}}}era",
  		:nous => "{{{1}}}é{{{2}}}e{{{3}}}{{{3}}}erons",
  		:vous => "{{{1}}}é{{{2}}}e{{{3}}}{{{3}}}erez",
  		:ils => "{{{1}}}é{{{2}}}e{{{3}}}{{{3}}}eront"
  	},
  	:conditional => {
  		:je => "{{{1}}}é{{{2}}}e{{{3}}}{{{3}}}erais",
  		:tu => "{{{1}}}é{{{2}}}e{{{3}}}{{{3}}}erais",
  		:il => "{{{1}}}é{{{2}}}e{{{3}}}{{{3}}}erait",
  		:nous => "{{{1}}}é{{{2}}}e{{{3}}}{{{3}}}erions",
  		:vous => "{{{1}}}é{{{2}}}e{{{3}}}{{{3}}}eriez",
  		:ils => "{{{1}}}é{{{2}}}e{{{3}}}{{{3}}}eraient"
  	},
  	
  	:present_participle => "{{{1}}}é{{{2}}}e{{{3}}}ant",
    :past_participle => "{{{1}}}é{{{2}}}e{{{3}}}é"
  },
